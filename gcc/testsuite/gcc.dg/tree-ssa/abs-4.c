...
/* { dg-final { scan-tree-dump-times "= ABS_EXPR" 1 "optimized" { target { ifn_copysign && { ! { s390*-*-* || { powerpc*-*-* && longdouble64 } } } } } } } */
/* { dg-final { scan-tree-dump-times "= -" 1 "optimized" { target { ifn_copysign && { ! { s390*-*-* || { powerpc*-*-* && longdouble64 } } } } } } } */
/* { dg-final { scan-tree-dump-times "= \.COPYSIGN" 2 "optimized" { target { ifn_copysign && { ! { s390*-*-* || { powerpc*-*-* && longdouble64 } } } } } } } */
/* { dg-final { scan-tree-dump-times "= \.COPYSIGN" 3 "optimized" { target { ifn_copysign && { s390*-*-* || { powerpc*-*-* && longdouble64 } } } } } } */
